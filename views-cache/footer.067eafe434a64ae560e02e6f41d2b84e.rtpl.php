                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <div class="footer-social">
                            <a href="https://www.facebook.com/pmagalhaesr" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://twitter.com/pmagalhaesr" target="_blank"><i class="fa fa-twitter"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2022 P Store. <a href="http://www.hcode.com.br" target="_blank">pecommerce.com.br</a></p>
                    </div>
                </div>
